...
// Genero personas para usar en el ArrayList
    ...
    Employee* p0 = newEmployee(1, "JUAN" ,"LOPEZ", 1330.22,5);
    Employee* p1 = newEmployee(2, "MARCOS" ,"PEREZ", 2330.22,5);
    Employee* p2 = newEmployee(3, "RAMON" ,"RODRIGUEZ", 3330.22,5);
    Employee* p3 = newEmployee(4, "SAMUEL" ,"GOMEZ", 4330.22,5);
    ...
    printf("\r\n\r\nHacemos pop de p2 en la posicion 3\r\n");
    Employee* p1Aux = lista->pop(lista,2);
